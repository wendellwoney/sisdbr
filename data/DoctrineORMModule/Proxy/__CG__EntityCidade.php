 ...
 */
class Cidade extends \Entity\Cidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Cidade' . "\0" . 'id', '' . "\0" . 'Entity\\Cidade' . "\0" . 'nome', '' . "\0" . 'Entity\\Cidade' . "\0" . 'ibge', '' . "\0" . 'Entity\\Cidade' . "\0" . 'estado'];
        }
